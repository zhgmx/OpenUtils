...
public class DenickerFeature extends ToggleableFeature {
	@Option(name = "Enable Denicker",
			description = "Identify likely Hypixel nicked players from their skin data.", order = 0)
	public boolean enabled;
	@Option(name = "Show failed denicks",
			description = "Report likely nicked players even when their real name cannot be recovered.",
			order = 1)
	public boolean showFailed = true;
	...
	public DenickerFeature() {
		super("Denicker", FeatureCategory.HYPIXEL);
	}
